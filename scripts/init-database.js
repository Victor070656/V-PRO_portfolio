    ...
    const sampleCourses = [
      {
        ...
        description: "Learn Next.js from scratch and build modern, full-stack web applications with React framework. This comprehensive course covers everything from basic concepts to advanced deployment strategies.",
