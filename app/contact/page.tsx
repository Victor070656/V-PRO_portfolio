  ...
  return (
    <div className="arch-shell">
      ...
      <main className="arch-container py-16 md:py-20 space-y-10">
        ...
        <section className="grid gap-6 lg:grid-cols-3">
          <div className="lg:col-span-2 arch-panel p-8">
          ...
          <aside className="arch-panel p-6">
            <p className="arch-kicker mb-4">Social</p>
            <div className="space-y-2">
              <Link className="arch-button-secondary w-full" href="https://x.com/victor10722752" target="_blank">
                <Twitter className="h-4 w-4" />
                Twitter
              </Link>
              <Link className="arch-button-secondary w-full" href="https://linkedin.com/in/victorikechukwu" target="_blank">
                <Linkedin className="h-4 w-4" />
                LinkedIn
              </Link>
              <Link className="arch-button-secondary w-full" href="https://github.com/Victor070656" target="_blank">
