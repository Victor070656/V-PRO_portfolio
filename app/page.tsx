          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="flex flex-col gap-8 text-center lg:text-left order-2 lg:order-1">
              ...
              <p className="text-lg md:text-xl text-[var(--text-secondary)] max-w-2xl mx-auto lg:mx-0 leading-relaxed">
                ...
                beautiful design with robust functionality. Passionate about modern web
              ...
              <div className="flex gap-8 justify-center lg:justify-start text-center">
                <div>
                  <div className="text-3xl font-bold text-[var(--primary-color)]">3+</div>
                  <div className="text-sm text-[var(--text-secondary)] font-medium">Years Experience</div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-[var(--primary-color)]">50+</div>
                  <div className="text-sm text-[var(--text-secondary)] font-medium">Projects Completed</div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-[var(--primary-color)]">100%</div>
                  <div className="text-sm text-[var(--text-secondary)] font-medium">Client Satisfaction</div>
                </div>
              </div>
              ...
              <div className="flex gap-6 justify-center lg:justify-start mt-6">
                <a href="#" className="text-[var(--text-secondary)] hover:text-[var(--primary-color)] transition-colors duration-300">
            ...
            <div className="relative w-full max-w-lg mx-auto order-1 lg:order-2">
              ...
              <div className="absolute bottom-1/4 -left-4 bg-white/90 dark:bg-slate-800/90 backdrop-blur-sm rounded-xl p-3 shadow-lg animate-float delay-500">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-semibold text-[var(--text-primary)]">Fast Delivery</span>
                </div>
              </div>
            </div>
          </div>
